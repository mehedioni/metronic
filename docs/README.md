...
Documentation for the store inventory system — a single-store, single-location
Laravel + Inertia + Vue application. Start with
[architecture.md](architecture.md).

| Document | Covers |
| --- | --- |
| [architecture.md](architecture.md) | Modules, models, services, actions, request flow |
| [authentication.md](authentication.md) | Session auth, password reset, verification, middleware |
| [authorization.md](authorization.md) | Spatie roles/permissions, policies, Super Admin setup |
